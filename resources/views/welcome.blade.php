            ...
            <div class="container position-relative d-flex align-items-center justify-content-between">
                ...
                <nav id="navmenu" class="navmenu">
                    <ul>
                        ...
                        <div>
                            <a href="{{ route('front.index') }}">Front <br> Dashboard</a>
                        </div>

                        <div>
                            <a href="{{ route('back.index') }}">Backend<br> Dashboard</a>
                        </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active show" id="departments-tab-1">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('website/assets/img/departments-1.jpg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="departments-tab-2">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('website/assets/img/departments-2.jpg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="departments-tab-3">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('website/assets/img/departments-3.jpg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="departments-tab-4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('website/assets/img/departments-4.jpg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="departments-tab-5">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('website/assets/img/departments-5.jpg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="team-member d-flex align-items-start">
                            <div class="pic"><img src="{{ asset('website/assets/img/doctors/doctors-1.jpg') }}"
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="team-member d-flex align-items-start">
                            <div class="pic"><img src="{{ asset('website/assets/img/doctors/doctors-2.jpg') }}"
                                    class="img-fluid" alt=""></div>
                            <div class="member-info">
                                <h4>Sarah Jhonson</h4>
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="team-member d-flex align-items-start">
                            <div class="pic"><img src="{{ asset('website/assets/img/doctors/doctors-3.jpg') }}"
                                    class="img-fluid" alt=""></div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
                        <div class="team-member d-flex align-items-start">
                            <div class="pic"><img src="{{ asset('website/assets/img/doctors/doctors-4.jpg') }}"
                                    class="img-fluid" alt=""></div>
                            <div class="member-info">
                                <h4>Amanda Jepson</h4>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('website/assets/img/gallery/gallery-1.jpg') }}" class="glightbox"
                                data-gallery="images-gallery">
                                <img src="{{ asset('website/assets/img/gallery/gallery-1.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('website/assets/img/gallery/gallery-2.jpg') }}" class="glightbox"
                                data-gallery="images-gallery">
                                <img src="{{ asset('website/assets/img/gallery/gallery-2.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div><!-- End Gallery Item -->
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('website/assets/img/gallery/gallery-3.jpg') }}" class="glightbox"
                                data-gallery="images-gallery">
                                <img src="{{ asset('website/assets/img/gallery/gallery-3.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div><!-- End Gallery Item -->
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('website/assets/img/gallery/gallery-4.jpg') }}" class="glightbox"
                                data-gallery="images-gallery">
                                <img src="{{ asset('website/assets/img/gallery/gallery-4.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div><!-- End Gallery Item -->
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('website/assets/img/gallery/gallery-5.jpg') }}" class="glightbox"
                                data-gallery="images-gallery">
                                <img src="{{ asset('website/assets/img/gallery/gallery-5.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div><!-- End Gallery Item -->
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('website/assets/img/gallery/gallery-6.jpg') }}" class="glightbox"
                                data-gallery="images-gallery">
                                <img src="{{ asset('website/assets/img/gallery/gallery-6.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div><!-- End Gallery Item -->
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('website/assets/img/gallery/gallery-7.jpg') }}" class="glightbox"
                                data-gallery="images-gallery">
                                <img src="{{ asset('website/assets/img/gallery/gallery-7.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div><!-- End Gallery Item -->
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('website/assets/img/gallery/gallery-8.jpg') }}" class="glightbox"
                                data-gallery="images-gallery">
                                <img src="{{ asset('website/assets/img/gallery/gallery-8.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div><!-- End Gallery Item -->
